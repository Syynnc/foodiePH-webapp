            ...
            <div className="bg-white border border-[#1a1208]/[0.07] rounded-2xl overflow-hidden">
                {loading ? (
                    ...
                    <div className="divide-y divide-[#1a1208]/[0.05]">
                        {/* Header row */}
                        <div className="hidden sm:grid grid-cols-[1fr_168px_auto_auto] gap-4 px-5 py-2.5 bg-[#1a1208]/[0.015]">
                        ...
                        {filtered.map((user) => (
                            <div key={user.id} className="flex flex-col sm:grid sm:grid-cols-[1fr_168px_auto_auto] gap-2 sm:gap-4 items-start sm:items-center px-5 py-4 hover:bg-[#1a1208]/[0.015] transition-colors duration-200">
                                {/* User info */}
